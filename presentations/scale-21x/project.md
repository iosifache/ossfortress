...
- Being Andrei
- Spending one hour together
- Talking about how to find vulnerabilities in codebases using open source tools
- Mentioning that any question during the presentation is more than welcomed
- Starting with a bit of background about myself
...
- Approximately 1.5 years ago, starting an open-core startup with a bunch of friends
- Stopping the startup because of lack of traction in the OSS and business space
- Deciding to leave the previous job when being for Christmas at my parents
...
- Leaving the Romanian Army
- Photo from one last year from the servers' room
...
- Entering Canonical, the company behind the Ubuntu distribution
- More precisely, the Ubuntu Security Team
- Photo from a team sprint in Bilbao, in which we participated at the Linux Security Summit
...
- At the same time, doing short sections for the podcast of the team, the Ubuntu Security Podcast
- Short briefs about cybersecurity papers
...
- Deep diving in the content
- Open source implies code that can be read by anyone.
- Ability of the attackers to audit the code and exploit the instances that are set by the users
- But it doesn't need to be this way.
- Having open source tools for finding vulnerabilities in our codebases
- Minimising the risk of publishing a vulnerable software on the Internet
...
- Giving some money to the maintainer of the tools you use
...
- Reporting bugs and vulnerabilities via email, GitHub issue or any other reporting channel that the upstream has
...
- Implementing features or solving bug reports for security tools
- Proposing patches for the vulnerabiltiies you discovered
...
- Andrei
- If there is a single thing to remember, it's this website.
- Presentation
- Exercises
- Cheatsheets
- And more
